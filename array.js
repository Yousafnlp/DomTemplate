...
function ProductFetching(){
    ...
    for(let i=0;i<products.length;i++){
            ...
            cards.classList.add("col-lg-3")
            // cards.classList.add("g-3")
        ...
        // id.innerHTML=`Id: ${products[i].id}`;
        title.innerHTML=products[i].title.slice(0,35);
        price.innerHTML="Price:"+" "+products[i].price;
        description.innerHTML=products[i].description.slice(0,100);
